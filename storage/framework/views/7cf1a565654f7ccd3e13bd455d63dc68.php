...
<?php $__env->startSection('title', 'PPDB Online ' . ($school_setting->ppdb_year ?: '2026/2027') . ' — ' . ($school_setting->school_name ?: 'MAN 1 Lombok Timur')); ?>
...
<section class="relative pt-20 pb-32 bg-gradient-to-br from-primary via-primary-dark to-accent overflow-hidden">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <div class="animate-fade-in-up">
            <?php if($school_setting->ppdb_status === 'open'): ?>
            ...
            <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                PENDAFTARAN PESERTA<br>DIDIK BARU <span class="text-secondary"><?php echo e($school_setting->ppdb_year ? explode('/', $school_setting->ppdb_year)[0] : '2026'); ?>/<?php echo e($school_setting->ppdb_year ? explode('/', $school_setting->ppdb_year)[1] ?? '2027' : '2027'); ?></span>
            </h1>
            <p class="text-white/80 max-w-2xl mx-auto text-lg font-medium mb-10 leading-relaxed">
                Mari bergabung menjadi bagian dari generasi hebat, religius, dan berprestasi di <?php echo e($school_setting->school_name ?: 'MAN 1 Lombok Timur'); ?>

            </p>
        </div>
        
        <div class="animate-fade-in-up-delay flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="<?php echo e(route('ppdb.informasi')); ?>" class="bg-white text-primary px-8 py-4 rounded-2xl font-bold text-sm shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] inline-flex items-center gap-2 uppercase tracking-wider">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Informasi Pendaftaran
            </a>
            <a href="<?php echo e(route('ppdb.daftar')); ?>" class="bg-secondary text-neutral px-8 py-4 rounded-2xl font-bold text-sm shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] inline-flex items-center gap-2 uppercase tracking-wider">
    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            ...
            <div class="text-center group">
                ...
                <span class="text-xs font-bold text-primary uppercase tracking-widest">Langkah <?php echo e($i + 1); ?></span>
                <h4 class="text-base font-bold text-neutral mt-1 mb-2"><?php echo e($step['title']); ?></h4>
                <p class="text-xs text-neutral/60 leading-relaxed"><?php echo e($step['desc']); ?></p>
            </div>
...
<section class="py-16 bg-white">
    <div class="max-w-3xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <?php if($school_setting->ppdb_status === 'open'): ?>
            <a href="<?php echo e(route('ppdb.register')); ?>" class="ppdb-btn text-sm px-8 py-4 !rounded-2xl uppercase tracking-wider">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>
                Buat Akun Baru
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('ppdb.daftar')); ?>" class="border-2 border-primary text-primary px-8 py-4 rounded-2xl font-bold text-sm hover:bg-primary hover:text-white transition-all uppercase tracking-wider inline-flex items-center gap-2">
...
<?php echo $__env->make('ppdb.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\man1selong\resources\views/ppdb/index.blade.php ENDPATH**/ ?>
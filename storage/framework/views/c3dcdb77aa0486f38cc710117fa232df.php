            ...
            <div class="relative z-10 text-center">
                <div class="mb-10 inline-block p-8 bg-white/10 backdrop-blur-2xl rounded-[3rem] border border-white/30 shadow-[0_30px_60px_rgba(0,0,0,0.3)] transform transition-all duration-700 hover:scale-105">
                    ...
                    <?php if($school_setting && $school_setting->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $school_setting->logo)); ?>" alt="Logo" class="h-40 w-auto drop-shadow-2xl">
                    <?php else: ?>
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-40 w-auto drop-shadow-2xl">
                    <?php endif; ?>
                </div>
                <div class="space-y-2">
                ...
                <div class="mb-12 text-center lg:text-left">
                    ...
                    <div class="lg:hidden flex flex-col items-center justify-center mb-10">
                        <div class="mb-5 inline-block p-4 bg-emerald-50 rounded-3xl border border-emerald-100 shadow-sm">
                            <?php $school_setting = \App\Models\SchoolSetting::first(); ?>
                            <?php if($school_setting && $school_setting->logo): ?>
                                <img src="<?php echo e(asset('storage/' . $school_setting->logo)); ?>" alt="Logo" class="h-20 w-auto">
                            <?php else: ?>
                                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-20 w-auto">
                            <?php endif; ?>
                        </div>
                ...
                <?php if($errors->any()): ?>
                    <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-r-xl">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="text-red-700 text-sm font-semibold"><?php echo e($error); ?></p>
...
<?php /**PATH D:\laragon\www\man1selong\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'MAN 1 Lombok Timur — Madrasah Unggul, Religius & Berprestasi'); ?>
<?php $__env->startSection('description', 'Website Resmi MAN 1 Lombok Timur, Lombok Timur. Madrasah berkualitas yang memadukan IPTEK dan IMTAQ.'); ?>
...
<section class="relative min-h-[90vh] flex items-center overflow-hidden pt-16 group">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e($school_setting->hero_image ? asset('storage/'.$school_setting->hero_image) : asset('images/hero-bg.png')); ?>" 
        ...
        <div class="max-w-4xl">
            ...
            <h1 class="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-[1.05] mb-6 drop-shadow-2xl tracking-tighter">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white/70">
                    <?php echo e($school_setting->hero_title ?: 'MAN 1 Lombok Timur'); ?>

                </span>
            </h1>

            <p class="text-white/90 text-lg sm:text-xl leading-relaxed mb-12 max-w-2xl font-medium drop-shadow-lg">
                <?php echo e($school_setting->hero_subtitle ?: 'Mencetak generasi cerdas, religius, dan berdaya saing global melalui pendidikan berkualitas berbasis iman dan takwa.'); ?>
    ...
    <div class="flex items-center max-w-7xl mx-auto px-4">
        ...
        <div class="overflow-hidden flex-1">
            <div class="animate-scroll flex whitespace-nowrap gap-20 text-sm font-semibold text-neutral">
                ...
                <span>📅 <?php echo e($agenda->title); ?> — <?php echo e(\Carbon\Carbon::parse($agenda->event_date)->format('d M Y')); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if($agendas->isEmpty()): ?>
        ...
        <div class="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
                <div class="text-neutral-light text-base leading-[1.9] mb-8">
                    <?php if($school_setting->history): ?>
                        <?php echo Str::limit(strip_tags($school_setting->history), 350); ?>
                ...
                <div class="grid sm:grid-cols-2 gap-5">
                    ...
                    <div class="p-5 rounded-xl border border-border bg-light/50 hover:shadow-md transition-all duration-300 group">
                        <span class="text-2xl block mb-2"><?php echo e($icon); ?></span>
                        <h4 class="font-bold text-sm text-neutral mb-1 group-hover:text-primary transition-colors"><?php echo e($title); ?></h4>
                        <p class="text-neutral-light text-xs leading-relaxed"><?php echo e($desc); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="relative lg:pl-10 group/img">
                ...
                <div class="relative rounded-2xl overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.4)] border-[6px] border-white ring-1 ring-black/5">
                    ...
                    <img src="<?php echo e(($school_setting->profile_image ? asset('storage/'.$school_setting->profile_image) : ($school_setting->hero_image ? asset('storage/'.$school_setting->hero_image) : asset('images/hero-bg.png'))) . '?v=' . time()); ?>" 
        ...
        <div class="grid lg:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-2xl p-8 border border-border shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="text-neutral-light leading-[1.9] text-base italic prose-content">
                    <?php echo $school_setting->vision ?: '"Terwujudnya Madrasah yang unggul, religius, berprestasi, dan berbasis teknologi dalam mencetak generasi yang beriman, berilmu, dan berakhlak mulia."'; ?>
            ...
            <div class="bg-white rounded-2xl p-8 border border-border shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="text-neutral-light leading-[1.9] text-base prose-content custom-misi">
                    <?php echo $school_setting->mission ?: '<ul><li>Menyelenggarakan pendidikan berkualitas berdasarkan nilai Islam.</li><li>Mengembangkan kurikulum relevan dengan IPTEK.</li><li>Membina prestasi akademik dan non-akademik.</li><li>Mewujudkan lingkungan islami dan kondusif.</li></ul>'; ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="bg-white rounded-2xl border border-border p-7 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div class="text-3xl font-extrabold text-primary mb-1"><?php echo e($stat->value); ?></div>
                <div class="text-neutral-light text-xs font-semibold tracking-wide uppercase"><?php echo e($stat->label); ?></div>
            </div>
            ...
            <div class="lg:col-span-2 flex justify-center">
                <div class="relative">
                    <div class="w-64 h-80 rounded-2xl overflow-hidden shadow-xl border-4 border-white ring-1 ring-border">
                        <img src="<?php echo e($school_setting->principal_photo ? asset('storage/'.$school_setting->principal_photo) : asset('images/kepala-sekolah.png')); ?>" alt="Kepala Madrasah"
            ...
            <div class="lg:col-span-3">
                ...
                <blockquote class="border-l-4 border-primary pl-5 mb-6">
                    <div class="text-neutral-light text-base leading-[1.9] italic prose-content">
                        <?php echo $school_setting->welcome_message ?: '"Pendidikan bukanlah semata-mata tentang ilmu pengetahuan..."'; ?>
                ...
                <div>
                    <p class="font-bold text-neutral"><?php echo e($school_setting->principal_name ?: 'Drs. H. Muhammad Amin, M.Pd.'); ?></p>
...
<section id="program" class="py-24 bg-light scroll-mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('program.detail', $program->slug)); ?>" class="bg-white rounded-2xl p-7 border border-border hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                <span class="text-3xl block mb-4"><?php echo e($program->icon ?: '✨'); ?></span>
                <h4 class="font-bold text-neutral mb-2 group-hover:text-primary transition-colors"><?php echo e($program->title); ?></h4>
                <p class="text-neutral-light text-sm leading-relaxed"><?php echo e($program->excerpt); ?></p>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<section id="berita" class="py-24 bg-white scroll-mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-14">
            ...
            <a href="<?php echo e(route('berita')); ?>" class="btn-outline !py-2.5 !px-5 !text-xs self-start sm:self-auto">
                Semua Berita
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
            ...
            <article class="bg-white rounded-2xl border border-border overflow-hidden group hover:shadow-xl transition-all duration-300">
                <div class="h-52 overflow-hidden relative">
                    <span class="absolute top-3 left-3 z-10 bg-primary text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-md"><?php echo e($post->category ?: 'Berita'); ?></span>
                    <img src="<?php echo e($post->image ? asset('storage/'.$post->image) : 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=800'); ?>" alt="<?php echo e($post->title); ?>"
                ...
                <div class="p-6">
                    ...
                    <h3 class="font-bold text-neutral leading-snug mb-2 group-hover:text-primary transition-colors line-clamp-2"><?php echo e($post->title); ?></h3>
                    <p class="text-neutral-light text-sm leading-relaxed line-clamp-3 mb-4"><?php echo e($post->excerpt ?: Str::limit(strip_tags($post->content), 100)); ?></p>
                    <a href="<?php echo e(route('berita')); ?>" class="inline-flex items-center gap-1 text-primary text-sm font-semibold hover:gap-2 transition-all">
                        Baca selengkapnya
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                    </a>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="rounded-xl overflow-hidden group cursor-pointer aspect-[4/3]">
                <img src="<?php echo e($gallery->image ? asset('storage/'.$gallery->image) : 'https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=600'); ?>" alt="<?php echo e($gallery->title ?: 'Galeri MAN 1 Lombok Timur'); ?>"
        ...
        <div class="text-center mt-10">
            <a href="<?php echo e(route('galeri')); ?>" class="btn-outline !py-2.5 !px-6 !text-xs">Lihat Semua Galeri</a>
        </div>
    </div>
</section>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl border border-border p-8 shadow-md flex flex-col justify-between">
                <div>
                    ...
                    <div class="space-y-5">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$paths, $label, $value]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 bg-primary-light text-primary rounded-xl flex items-center justify-center flex-shrink-0">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <?php $__currentLoopData = explode('|', $paths); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($d); ?>"/>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </svg>
                            </div>
                            <div>
                                <p class="text-xs font-bold text-neutral uppercase tracking-wide"><?php echo e($label); ?></p>
                                <p class="text-neutral-light text-sm mt-0.5"><?php echo e($value); ?></p>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<section id="ppdb" class="relative py-20 bg-primary overflow-hidden scroll-mt-20">
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="<?php echo e(route('ppdb')); ?>" class="btn-gold !py-3.5 !px-10">Daftar Sekarang</a>
            <a href="<?php echo e(route('ppdb')); ?>" class="bg-transparent border-2 border-white/30 text-white px-10 py-3.5 rounded-xl font-semibold text-sm hover:bg-white/10 transition cursor-pointer inline-flex items-center gap-2">
                Info PPDB
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\man1selong\resources\views/welcome.blade.php ENDPATH**/ ?>
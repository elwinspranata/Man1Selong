...
<?php $__env->startSection('title', 'Hubungi Kami — MAN 1 Lombok Timur'); ?>
                ...
                <div class="space-y-6 mb-12">
                    <div class="flex gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-neutral-light text-sm"><?php echo e($school_setting->address ?: 'Jl. Pejanggik No. 123, Selong, Lombok Timur, NTB 83611'); ?></p>
                        </div>
                    </div>
                    <div class="flex gap-5">
                        <div class="w-12 h-12 bg-primary/10 text-primary rounded-xl flex items-center justify-center shrink-0">📧</div>
                        <div>
                            ...
                            <p class="text-neutral-light text-sm"><?php echo e($school_setting->email ?: 'info@man1lomboktimur.sch.id'); ?></p>
                        </div>
                    </div>
                    <div class="flex gap-5">
                        <div class="w-12 h-12 bg-primary/10 text-primary rounded-xl flex items-center justify-center shrink-0">📞</div>
                        <div>
                            ...
                            <p class="text-neutral-light text-sm"><?php echo e($school_setting->phone ?: '(0376) 21234'); ?> — Aktif jam kerja</p>
                        </div>
                    </div>
                </div>

                <div class="rounded-3xl overflow-hidden shadow-lg border border-border h-80">
                    <iframe src="<?php echo e($school_setting->map_url ?: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15771.2!2d116.52!3d-8.65'); ?>" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
            </div>
...
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\man1selong\resources\views/pages/kontak.blade.php ENDPATH**/ ?>
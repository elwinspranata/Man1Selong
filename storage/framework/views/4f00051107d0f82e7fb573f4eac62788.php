...
<footer class="bg-primary-dark text-white">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                <div class="flex items-center gap-3 mb-5">
                    <img src="<?php echo e($school_setting->logo ? asset('storage/'.$school_setting->logo) : asset('images/logo.png')); ?>" alt="Logo" class="h-12 w-auto">
                    <div class="leading-tight">
                        <span class="block font-bold text-base"><?php echo e($school_setting->school_name ?: 'MAN 1 Lombok Timur'); ?></span>
                        <span class="block text-white/40 text-[10px] font-semibold tracking-widest uppercase"><?php echo e($school_setting->school_alias ?: 'Kemenag Lotim'); ?></span>
                    </div>
                </div>
                ...
                <div class="flex gap-2.5">
                    ...
                    <?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($social['url']): ?>
                        <a href="<?php echo e($social['url']); ?>" target="_blank" aria-label="<?php echo e($social['name']); ?>"
                           class="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-secondary hover:text-neutral transition-all duration-200 text-white/60 hover:scale-105">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="<?php echo e($social['icon']); ?>"/></svg>
                        </a>
                        <?php endif; ?>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$link, $href]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e($href); ?>" class="text-white/50 hover:text-secondary transition-colors flex items-center gap-2 group">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start gap-3 text-white/50">
                        ...
                        <?php echo e($school_setting->address ?: 'Jl. Pejanggik No. 123, Selong, Lombok Timur, NTB'); ?>
                    ...
                    <li class="flex items-center gap-3 text-white/50">
                        ...
                        <?php echo e($school_setting->phone ?: '(0376) 21234'); ?>
                    ...
                    <li class="flex items-center gap-3 text-white/50">
                        ...
                        <?php echo e($school_setting->email ?: 'info@man1lomboktimur.sch.id'); ?>
    ...
    <div class="border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-white/30">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($school_setting->school_name ?: 'MAN 1 Lombok Timur'); ?>. Seluruh hak cipta dilindungi.</p>
            <p>Dikelola oleh <span class="text-secondary/80 font-semibold">Tim IT <?php echo e($school_setting->school_alias ?: 'MAN 1 Lombok Timur'); ?></span></p>
        </div>
    </div>
</footer>
<?php /**PATH D:\laragon\www\man1selong\resources\views/components/footer.blade.php ENDPATH**/ ?>
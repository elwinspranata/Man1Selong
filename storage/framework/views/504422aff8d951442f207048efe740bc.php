...
<?php $__env->startSection('title', 'Profil — MAN 1 Lombok Timur'); ?>

<?php $__env->startSection('content'); ?>

<section class="relative pt-32 pb-20 bg-primary-dark overflow-hidden">
    <div class="absolute inset-0 opacity-10">
        <img src="<?php echo e(asset('images/hero-bg.png')); ?>" class="w-full h-full object-cover">
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <div class="space-y-4 text-neutral-light leading-relaxed">
                    <?php if($school_setting->history): ?>
                        <?php echo $school_setting->history; ?>
            ...
            <div class="rounded-3xl overflow-hidden shadow-2xl border-8 border-light">
                <img src="<?php echo e($school_setting->profile_image ? asset('storage/'.$school_setting->profile_image) : asset('images/hero-bg.png')); ?>" class="w-full h-80 object-cover">
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-white">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <div class="mb-10 inline-block p-1 border-4 border-primary rounded-full">
            <img src="<?php echo e($school_setting->principal_photo ? asset('storage/'.$school_setting->principal_photo) : asset('images/kepala-sekolah.png')); ?>" class="w-40 h-40 rounded-full object-cover">
        </div>
        <div class="text-3xl font-bold text-neutral mb-8 italic prose-xl max-w-none">
            <?php echo $school_setting->welcome_message ?: '"Pendidikan adalah kunci pembentukan karakter. Kami hadir untuk membimbing setiap siswa menemukan potensi terbaiknya."'; ?>

        </div>
        <div class="w-20 h-1 bg-primary mx-auto mb-6"></div>
        <p class="font-extrabold text-neutral text-xl"><?php echo e($school_setting->principal_name ?: 'Drs. H. Muhammad Amin, M.Pd.'); ?></p>
        <p class="text-neutral-light">Kepala <?php echo e($school_setting->school_name ?: 'MAN 1 Lombok Timur'); ?></p>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\man1selong\resources\views/pages/profil.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Informasi PPDB — ' . ($school_setting->school_name ?: 'MAN 1 Lombok Timur')); ?>
    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="ppdb-card p-6 md:p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <?php if($school_setting->phone): ?>
                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $school_setting->phone)); ?>" target="_blank" class="ppdb-btn" style="background-color:#16a34a;font-size:0.875rem">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('ppdb.daftar')); ?>" class="ppdb-btn text-sm">
                    Mulai Pendaftaran
                </a>
            </div>
        </div>
...
<?php echo $__env->make('ppdb.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\man1selong\resources\views/ppdb/informasi.blade.php ENDPATH**/ ?>
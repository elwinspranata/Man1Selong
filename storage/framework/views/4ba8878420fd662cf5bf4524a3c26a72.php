...
<?php $__env->startSection('page_title', 'Ringkasan Dashboard'); ?>
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 group hover:border-emerald-500 transition-all duration-300">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-black text-slate-900"><?php echo e($stats['posts_count']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 group hover:border-emerald-500 transition-all duration-300">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-black text-slate-900"><?php echo e($stats['teachers_count']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 group hover:border-emerald-500 transition-all duration-300">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-black text-slate-900"><?php echo e($stats['agendas_count']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 group hover:border-emerald-500 transition-all duration-300">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-black text-slate-900"><?php echo e($stats['registrants_count']); ?></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:border-emerald-500 transition-all duration-300">
            <div class="flex items-center justify-between mb-8">
                ...
                <span class="px-4 py-1.5 bg-slate-100 text-slate-700 font-extrabold text-xs tracking-widest uppercase rounded-xl border border-slate-200">Total: <?php echo e($ppdb_stats['prestasi']['total']); ?> Pendaftar</span>
            </div>
            <div class="space-y-6">
                <div>
                    <div class="flex justify-between text-sm font-bold mb-2">
                        ...
                        <span class="text-emerald-700"><?php echo e($ppdb_stats['prestasi']['accepted']); ?> / <?php echo e($ppdb_stats['prestasi']['total']); ?></span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-3">
                        <div class="bg-emerald-500 h-3 rounded-full transition-all duration-1000" style="width: <?php echo e($ppdb_stats['prestasi']['total'] > 0 ? ($ppdb_stats['prestasi']['accepted'] / $ppdb_stats['prestasi']['total'] * 100) : 0); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between text-sm font-bold mb-2">
                        <span class="text-yellow-600 flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-yellow-400"></div>Proses Validasi</span>
                        <span class="text-yellow-700"><?php echo e($ppdb_stats['prestasi']['process']); ?> / <?php echo e($ppdb_stats['prestasi']['total']); ?></span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-3">
                        <div class="bg-yellow-400 h-3 rounded-full transition-all duration-1000" style="width: <?php echo e($ppdb_stats['prestasi']['total'] > 0 ? ($ppdb_stats['prestasi']['process'] / $ppdb_stats['prestasi']['total'] * 100) : 0); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between text-sm font-bold mb-2">
                        <span class="text-red-500 flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-red-500"></div>Ditolak</span>
                        <span class="text-red-600"><?php echo e($ppdb_stats['prestasi']['rejected']); ?> / <?php echo e($ppdb_stats['prestasi']['total']); ?></span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-3">
                        <div class="bg-red-500 h-3 rounded-full transition-all duration-1000" style="width: <?php echo e($ppdb_stats['prestasi']['total'] > 0 ? ($ppdb_stats['prestasi']['rejected'] / $ppdb_stats['prestasi']['total'] * 100) : 0); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:border-emerald-500 transition-all duration-300">
            <div class="flex items-center justify-between mb-8">
                ...
                <span class="px-4 py-1.5 bg-slate-100 text-slate-700 font-extrabold text-xs tracking-widest uppercase rounded-xl border border-slate-200">Total: <?php echo e($ppdb_stats['reguler']['total']); ?> Pendaftar</span>
            </div>
            <div class="space-y-6">
                <div>
                    <div class="flex justify-between text-sm font-bold mb-2">
                        <span class="text-emerald-600 flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-emerald-500"></div>Diterima</span>
                        <span class="text-emerald-700"><?php echo e($ppdb_stats['reguler']['accepted']); ?> / <?php echo e($ppdb_stats['reguler']['total']); ?></span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-3">
                        <div class="bg-emerald-500 h-3 rounded-full transition-all duration-1000" style="width: <?php echo e($ppdb_stats['reguler']['total'] > 0 ? ($ppdb_stats['reguler']['accepted'] / $ppdb_stats['reguler']['total'] * 100) : 0); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between text-sm font-bold mb-2">
                        <span class="text-yellow-600 flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-yellow-400"></div>Proses Validasi</span>
                        <span class="text-yellow-700"><?php echo e($ppdb_stats['reguler']['process']); ?> / <?php echo e($ppdb_stats['reguler']['total']); ?></span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-3">
                        <div class="bg-yellow-400 h-3 rounded-full transition-all duration-1000" style="width: <?php echo e($ppdb_stats['reguler']['total'] > 0 ? ($ppdb_stats['reguler']['process'] / $ppdb_stats['reguler']['total'] * 100) : 0); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between text-sm font-bold mb-2">
                        <span class="text-red-500 flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-red-500"></div>Ditolak</span>
                        <span class="text-red-600"><?php echo e($ppdb_stats['reguler']['rejected']); ?> / <?php echo e($ppdb_stats['reguler']['total']); ?></span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-3">
                        <div class="bg-red-500 h-3 rounded-full transition-all duration-1000" style="width: <?php echo e($ppdb_stats['reguler']['total'] > 0 ? ($ppdb_stats['reguler']['rejected'] / $ppdb_stats['reguler']['total'] * 100) : 0); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\man1selong\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
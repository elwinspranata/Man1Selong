...
@section('title', 'Sambutan Kepala Madrasah — MAN 1 Lombok Timur')
        ...
        <div class="grid lg:grid-cols-5 gap-16 items-start">
            ...
            <div class="lg:col-span-2">
                <div class="relative group">
                    ...
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl border-x-8 border-t-8 border-light">
                        <img src="{{ $school_setting->principal_photo ? asset('storage/'.$school_setting->principal_photo) : asset('images/kepala-sekolah.png') }}" class="w-full h-[500px] object-cover object-top">
                    </div>
                    <div class="mt-8 p-6 bg-light rounded-2xl border border-border text-center">
                        ...
                        <p class="text-primary font-bold text-sm uppercase tracking-widest mt-1">Kepala {{ $school_setting->school_name ?: 'MAN 1 Lombok Timur' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="space-y-6 text-neutral-light leading-relaxed text-lg italic prose-xl max-w-none">
                    {!! $school_setting->welcome_message ?: '<p>Assalamu’alaikum Warahmatullahi Wabarakatuh,</p><p>Puji syukur kita panjatkan ke hadirat Allah SWT... selamat datang di portal resmi MAN 1 Lombok Timur.</p>' !!}
                </div>
                <div class="mt-12 flex items-center gap-6">
                    <div class="w-16 h-1 bg-primary rounded-full"></div>
                    <p class="text-neutral font-bold tracking-widest uppercase">Selong, {{ now()->translatedFormat('F Y') }}</p>
                </div>
            </div>
        </div>
    </div>

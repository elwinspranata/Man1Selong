...
<div class="max-w-5xl mx-auto">
    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-200">
            <h3 class="text-2xl font-black text-slate-800 tracking-tight mb-8">Detail Berita</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    <label class="text-sm font-bold text-slate-600 ml-1">Gambar Utama</label>
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <textarea name="excerpt" rows="2"
                        ...
                        placeholder="Ringkasan pendek berita untuk tampilan kartu...">{{ old('excerpt') }}</textarea>
                </div>

                <div class="md:col-span-2 space-y-2">
                    <label class="text-sm font-bold text-slate-600 ml-1">Konten Berita</label>
                    <textarea name="content" id="editor" rows="15"
                        class="w-full px-6 py-4 bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 rounded-3xl outline-none transition-all font-medium"
                ...
                <div class="md:col-span-2 pt-4">
                    <label class="flex items-center group cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-bold text-slate-600 group-hover:text-slate-900 transition-colors">Terbitkan Langsung</span>
                    </label>
                </div>
            </div>
        </div>

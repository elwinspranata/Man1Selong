...
@section('page_title', 'Tambah Statistik')
...
<div class="max-w-4xl mx-auto">
    ...
    <form Action="{{ route('admin.student_statistics.store') }}" method="POST" class="space-y-8">
        @csrf
        
        <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-200">
            <h3 class="text-2xl font-black text-slate-800 tracking-tight mb-8">Informasi Data Siswa</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <input type="number" min="0" name="male_count" value="{{ old('male_count', 0) }}" required
                ...
                <div class="space-y-4">
                    ...
                    <input type="number" min="0" name="female_count" value="{{ old('female_count', 0) }}" required

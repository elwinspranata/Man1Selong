...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
        
        <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-200">
            <h3 class="text-2xl font-black text-slate-800 tracking-tight mb-8">Ubah Informasi Guru</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="position" value="{{ old('position', $teacher->position) }}" required
                        class="w-full px-6 py-4 bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 rounded-2xl outline-none transition-all font-medium"
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', $teacher->sort_order) }}" required
                        class="w-full px-6 py-4 bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 rounded-2xl outline-none transition-all font-medium">
                </div>
                ...
                <div class="md:col-span-2 space-y-4 pt-4">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-slate-400 mt-2 font-medium">Biarkan kosong jika tidak ingin mengubah foto.</p>
                        </div>
                    </div>
                </div>

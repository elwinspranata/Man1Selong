...
<div class="max-w-5xl mx-auto">
    ...
    <form Action="{{ route('admin.extracurriculars.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        
        <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-200">
            <h3 class="text-2xl font-black text-slate-800 tracking-tight mb-8">Detail Ekstrakurikuler</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}"
                        class="w-full px-6 py-4 bg-slate-50 border-2 border-transparent focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/5 rounded-2xl outline-none transition-all font-medium"
                        placeholder="Contoh: tent / cross / flag">
                </div>

                <div class="space-y-4">
                    <label class="text-sm font-bold text-slate-600 ml-1">Gambar Cover</label>
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <textarea name="excerpt" rows="2"
                        ...
                        placeholder="Penjelasan singkat ekskul...">{{ old('excerpt') }}</textarea>
                </div>
